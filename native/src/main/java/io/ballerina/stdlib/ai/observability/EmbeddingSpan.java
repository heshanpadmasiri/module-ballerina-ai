...
public class EmbeddingSpan extends Span {

    public EmbeddingSpan(String name) {
        super(name);
    }
    ...
    public void init(OITracer tracer) {
        ...
        SpanBuilder sb = tracer.spanBuilder(name).setSpanKind(io.opentelemetry.api.trace.SpanKind.CLIENT)
                .setAttribute("SpanAttributes.OPENINFERENCE_SPAN_KIND", SpanKind.EMBEDDING.toString());
